...
{winner.header === "Bangladesh Nationalist Party" ? <img src={Image2} alt="" className="party-pic" /> : (
  winner.header === "Awami League" ? <img src={Image1} alt="" className="party-pic" /> : (
    winner.header === "Jatiya Party" ? <img src={Image3} alt="" className="party-pic" /> : <img src={Image4} alt="" className="party-pic" />
  )
)}
{" "}
...
export function displayResults(candidates) {
  const renderResults = (candidate, idx) => {
    return (
      <tr>
        {/* <td>{candidate.id}</td> */}
